...
public class BitmapDrawerBarGraphV4 extends BitmapDrawer {
	...
	public Bitmap drawBitmap(final int level) {
		...
		einerDicke = Math.round(bHeight * 0.20f);
	...
	public void drawLevelNumber(final int level) {
		...
		bitmapCanvas.drawText("" + level, 0 + 2 * offset, bHeight - 0 * einerDicke - 3 * offset, getNumberPaintAlignLeft(level, fontSize));
	}
