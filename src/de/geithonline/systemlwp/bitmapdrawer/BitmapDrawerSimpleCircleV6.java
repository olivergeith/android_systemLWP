...
public class BitmapDrawerSimpleCircleV6 extends BitmapDrawer {
	...
	private void drawSegmente(final int level) {
		...
		// scala
		bitmapCanvas.drawArc(getRectForOffset(offset + fontSizeArc), 270, 360, true, getBackgroundPaint());
		// level
		bitmapCanvas.drawArc(getRectForOffset(offset + fontSizeArc), 270, Math.round(level * 3.6), true, getBatteryPaint(level));
