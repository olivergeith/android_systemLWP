...
public class BitmapDrawerSimpleCircleV7 extends BitmapDrawer {
	...
	public BitmapDrawerSimpleCircleV7() {
	}
	...
	private void drawSegmente(final int level) {
		...
		bitmapCanvas.drawArc(getRectForOffset(offset + fontSizeArc), 270, -Math.round((100 - level) * 3.6), true, btPaint);
		bitmapCanvas.drawArc(getRectForOffset(offset + fontSizeArc), 270, Math.round((level) * 3.6), true, bgPaint);
		// delete inner Circle
